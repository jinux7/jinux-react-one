...
import './lightAnalyze.less';
import WindBar from  '../windAnalyze/bar/bar';
import StatusTable  from  '@/components/modules/everyMoment/status/table/table_status';
...
class LightAnalyze extends Component{
    constructor(props){
        super(props);
        this.state= {
    ...
    render(){
        return(
            <div id='wrap_lightAnalyze'>
                <ContainBox>
                    <div className='head_party'>
                     <DateRange showTime ={(value)=>{ console.log(value)}} />
                     </div>
                     <div className='head_party'>
                     <CommonInput name={'电站名称'} showValue={(value)=>{ console.log(value)}}/>>
                     </div>
